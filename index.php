...
if (isset($GLOBALS['redir'])) {
    $appid = $GLOBALS['redir'];
    echo "<script>console.log('App-ID: ' + '$appid')</script>";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($GLOBALS['token'] != FALSE) {
        ...
        if (isset($appid)) {
            header("Location: /authorize.php?appid=$appid");
            exit();
        }
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://localhost:8000/users/me",
